...
const Shoes = () => {
    ...
    const [shoesShopData, setShoesShopData] = useState([])
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const shoesData = formatedData.filter((elem) => elem.category.includes("shoes"));


                setShoesShopData(shoesData)
    ...
    const currentProduct = shoesShopData.slice(indexOfFirstProduct, indexofLastProduct)

    //Pagination logic
    const pageNumbers = []

    const totalProducts = shoesShopData.length
        ...
        <>
            ...
            <div className={manfashionstyle.mainContainer}>
                ...
                <div className={manfashionstyle.allProductsContainer}>
                    {shoesShopData && shoesShopData.length > 0 && (
